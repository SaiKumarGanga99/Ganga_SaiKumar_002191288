...
//        this.restaurantDirectory = ecoSystem.getRestaurantDirectory();
        System.out.println(ecoSystem.getRestaurantDirectory().getRestaurantDirectory().size() + "   ...... ");
    ...
    private void btnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyActionPerformed
        ...
        ModifyRestaurantInfoJPanel modifyManager = new ModifyRestaurantInfoJPanel(userProcessContainer, ecoSystem, ecoSystem.getRestaurantDirectory(), restaurant);
